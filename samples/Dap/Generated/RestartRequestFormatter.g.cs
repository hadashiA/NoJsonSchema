...
public static partial class RestartRequestFormatter
{
            ...
            switch (__name.Length)
            {
                ...
                case 9:
                    ...
                    
                    {
                        ...
                        {
                            tokenizer.ReadStartObject();
                            var sub_Arguments = new RestartArguments();
                            RestartArgumentsFormatter.ReadInto(ref tokenizer, sub_Arguments, options);
    ...
    internal static void WriteValue(ref Utf8JsonBufferWriter w, RestartRequest value, NoJsonSerializerOptions options)
    {
        ...
        {
            w.WritePropertyNameRaw(Name_Arguments);
            RestartArgumentsFormatter.WriteValue(ref w, value.Arguments!, options);
        }
        w.WriteEndObject();
    }
}

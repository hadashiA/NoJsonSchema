...
public static class TypeEmitter
{
    ...
    {
        // `<auto-generated/>` flips Roslyn's IsGeneratedCode flag (skips most analyzers), but
        // compiler warnings (CSxxxx) still fire. With TreatWarningsAsErrors the build would break
        // on innocuous things like CS8618 / CS8602 / CS0219 inside emit. `#pragma warning disable`
        // silences the entire file — consumers focus on their own code, not ours.
